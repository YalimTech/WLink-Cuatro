              ...
              return (
                <div className="space-y-8 w-full">
                  ...
                  <header className="flex items-center justify-between">
                    ...
                    <button onClick={toggleTheme} className={\`p-3 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 \${theme === 'dark' ? 'bg-gray-700 text-yellow-300 hover:bg-gray-600 focus:ring-offset-gray-800 focus:ring-yellow-400' : 'bg-gray-200 text-white hover:bg-gray-300 focus:ring-offset-gray-100 focus:ring-indigo-500'}\`}>
                      {theme === 'dark' ? 
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                           <path d="M10 2a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0110 2zM10 15a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0110 15zM10 7a3 3 0 100 6 3 3 0 000-6zM15.657 5.404a.75.75 0 10-1.06-1.06l-1.061 1.06a.75.75 0 001.06 1.06l1.06-1.06zM6.464 14.596a.75.75 0 10-1.06-1.06l-1.06 1.06a.75.75 0 001.06 1.06l1.06-1.06zM18 10a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0118 10zM5.404 6.464a.75.75 0 10-1.06-1.06l-1.06 1.06a.75.75 0 001.06 1.06l1.06-1.06zM15.657 14.596a.75.75 0 101.06-1.06l-1.06-1.061a.75.75 0 10-1.06 1.06l1.06 1.06zM6.464 5.404a.75.75 0 101.06-1.06l-1.06-1.061a.75.75 0 00-1.06 1.06l1.06 1.06zM4 10a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 014 10z"/>
                        </svg>
                        : 
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
