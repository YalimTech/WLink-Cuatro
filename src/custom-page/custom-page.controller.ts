              ...
              return (
                <div className="space-y-8 w-full">
                  ...
                  <header className="flex items-center justify-between">
                    ...
                    <button onClick={toggleTheme} className={\`p-3 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 \${theme === 'dark' ? 'bg-gray-700 text-white hover:bg-gray-600 focus:ring-offset-gray-800 focus:ring-white' : 'bg-gray-200 text-indigo-600 hover:bg-gray-300 focus:ring-offset-gray-100 focus:ring-indigo-500'}\`}>
                      {theme === 'dark' ?
