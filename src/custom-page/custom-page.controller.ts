                      ...
                      <form onSubmit={createInstance} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <input type="text" id="instanceGuid" className={\`sm:text-sm rounded-lg block w-full p-2.5 focus:ring-indigo-500 focus:border-indigo-500 \${theme === 'dark' ? 'bg-slate-700 border-slate-600 placeholder-gray-400 text-white' : 'bg-gray-100 border-gray-300 placeholder-gray-500 text-gray-900'}\`} value={form.instanceId || ''} onChange={(e) => setForm({ ...form, instanceId: e.target.value })} placeholder="e.g., a1b2c3d3-e5f6h7-etc" required />
                          </div>
                          <div>
